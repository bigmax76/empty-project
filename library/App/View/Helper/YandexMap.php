...
{
	public function yandexMap(Model_Shop $shop)	 
    {    	    	
		...
		return '<div id="YMapsID" class="span-15" style="margin-top:0;height:300px"></div>'; 
    }
		    ...
		    YMaps.jQuery(function () 
		    	{
		            ...
		            // Создание перетаскиваемой метки
                    var placemark = new YMaps.Placemark(map.getCenter(), {draggable: false});
                    map.addOverlay(placemark);
                    placemark.setIconContent   ("' . $name . '");
                    placemark.setBalloonContent("' . $adress . '");
