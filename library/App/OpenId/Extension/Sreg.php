 ...
 */
class App_OpenId_Extension_Sreg extends Zend_OpenId_Extension
{
    /**
    ...
    public function prepareRequest(&$params)
    {
        ...
        if (is_array($this->_props) && count($this->_props) > 0) {
            ...
            $params['openid.ns.ax'] = APP_OpenId_Extension_Sreg::NAMESPACE_1_0;
            $params['openid.ax.mode'] = App_OpenId_Extension_Sreg::MODE;
